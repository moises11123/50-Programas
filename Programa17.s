...
//prompt = "Ordenando el array usando el método de selección...\n"  // Mensaje de inicio
//sortedMsg = "Array ordenado:\n"                                   // Mensaje de confirmación
//array = [5, 3, 8, 1, 2]                                           // Array a ordenar
//length = len(array)                                               // Longitud del array
//newline = "\n"                                                    // Nueva línea

// Mostrar el mensaje de inicio
//print(prompt)                                                     // Imprime el mensaje inicial

// Implementación del algoritmo de selección para ordenar el array
//def selection_sort(arr):
//    n = len(arr)                                                  // Longitud del array
//    for i in range(n):                                            // Bucle externo para cada posición
//        min_idx = i                                               // Índice inicial asumido como mínimo
//        for j in range(i + 1, n):                                 // Bucle interno para encontrar el mínimo
//            if arr[j] < arr[min_idx]:                             // Comparación para hallar el mínimo
//                min_idx = j                                       // Actualizar índice mínimo
//        arr[i], arr[min_idx] = arr[min_idx], arr[i]               // Intercambiar el mínimo con el actual

// Ordenar el array con selection_sort
//selection_sort(array)

// Mostrar mensaje de array ordenado
//print(sortedMsg)                                                  // Imprime mensaje de array ordenado
